# File: src/nilo/core/attachments/database_attachment.py
# Format: UTF-8
# =============================
# File Description:
...
from nilo.core.errors import DatabaseDataSourceSelectionError
...
class DatabaseAttachment(BaseModel):
    ...
    # Usage:
    # attachment.refreshed(database_response, command="nilo database refresh")
    # --------------------------------
