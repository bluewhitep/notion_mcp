...
For Codex runtime discovery, repository-level skills live under `.agents/skills/`. `Docs/JP/Developer/Reference/Skills/` is the template and documentation library used to design or copy those runtime skills.

## Layout
```text
Docs/JP/Developer/Reference/Skills/
  README.md
  CHANGELOG.md
  references/
    quick.md
