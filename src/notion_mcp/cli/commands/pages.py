...
# Usage:
# notion-mcp page attach PAGE_ID --json
# --------------------------------
def attach_page(
    page_id: str,
    ...
    try:
        ...
        if verify:
            ...
            attachment = PageAttachment.from_page_response(page_response, command="notion-mcp page attach")
        else:
...
def page_refresh(
    ...
    try:
        ...
        updated = attachment.refreshed(page_response, command="notion-mcp page refresh")
