# File: src/nilo/core/attachments/page_attachment.py
# Format: UTF-8
# =============================
# File Description:
...
from nilo.core.project.project_config import timestamp_utc
...
class PageAttachment(BaseModel):
    ...
    # Usage:
    # PageAttachment.from_page_response(page, command="nilo page attach")
    # --------------------------------
    @classmethod
    ...
    # Usage:
    # attachment.refreshed(page_response, command="nilo page refresh")
    # --------------------------------
...
# Usage:
# build_page_attachment_from_response(page, command="nilo page attach")
# --------------------------------
