...
For Codex runtime discovery, repository-level skills live under `.agents/skills/`. `Docs/skills/` is the template and documentation library used to design or copy those runtime skills.
